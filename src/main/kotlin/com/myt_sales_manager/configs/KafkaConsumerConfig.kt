package com.myt_sales_manager.configs
...
class KafkaConsumerConfig(
    ...
    private fun <T> builderConsumerFactory(type: Class<T>): ConsumerFactory<String, T>{
        ...
        val configs = mapOf(
            ...
            ConsumerConfig.GROUP_ID_CONFIG to "sales-group",
    ...
    @Bean
    fun soldItemFactory(): ConcurrentKafkaListenerContainerFactory<String, SoldItemDto> =
        buildKafkaListenerContainerFactory(SoldItemDto::class.java)
